...
export const colors = {
  primary: '#292524',       // ink pill (primary CTA) — NOT a saturated brand color
  ...
  body: '#4e4e4e',
  bodySoft: '#777169',
  mute: '#e7e5e4',          // default hairline
  muteSoft: 'rgba(120,113,108,0.08)',
  canvas: '#ffffff',        // surface-card
  canvasSoft: '#f5f5f5',    // off-white page floor
  onDark: '#ffffff',
